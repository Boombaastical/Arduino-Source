...
class SingleTreeHunter_Descriptor : public SingleSwitchProgramDescriptor{
public:
    SingleTreeHunter_Descriptor();

    class Stats;
    virtual std::unique_ptr<StatsTracker> make_stats() const override;
};

class SingleTreeHunter : public SingleSwitchProgramInstance{
public:
    SingleTreeHunter();
...
private:
    SimpleIntegerOption<uint32_t> TREE_SELECT;
    SimpleIntegerOption<uint32_t> KNOCKS;
    ProgramNotifications NOTIFICATIONS;
