...
static std::vector<std::unique_ptr<AutoStory_Checkpoint>> make_checkpoint_list(){
    ...
    checkpoint_list.emplace_back(std::make_unique<AutoStory_Checkpoint_017>());
    checkpoint_list.emplace_back(std::make_unique<AutoStory_checkpoint_018>());
    checkpoint_list.emplace_back(std::make_unique<AutoStory_Checkpoint_019>());
    checkpoint_list.emplace_back(std::make_unique<AutoStory_Checkpoint_020>());
